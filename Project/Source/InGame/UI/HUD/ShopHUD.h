...
private:
	...
	void setNumberTexture(vTexSet& texture, const std::string& fileName);
	void drawNumberTexture(std::unique_ptr<class Shader>& shader, const vTexSet& texture, const Vector2& pos);
};