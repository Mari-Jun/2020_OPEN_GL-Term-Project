...
void TitleScene::loadData()
{
	...
	ui->addButton([this]() {mSceneHelper->createDialog("NotYet"); }, Vector2(0.0f, -80.0f), "Asset/Image/Button/HelpButton");
	ui->addButton([this]() {mSceneHelper->changeToSettingScene(mInfo); }, Vector2(0.0f, -190.0f), "Asset/Image/Button/SetButton");
	...
	ui->addButton([this]() {mSceneHelper->changeToShopScene(mInfo); }, Vector2(500.0f, -190.0f), "Asset/Image/Button/ShopButton");
}
